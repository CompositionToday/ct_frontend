...
import {OpportunityLinkTitle, OpportunityTitle} from "./OpportunityInfoHelper";
...
export function NewsOpportunity({ apiEndpoint }: OpportunityProp) {
    ...
    // const date = currentOpportunity?.published_date
                                        ...
                                        (opportunity: OpportunityItem) => {
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <OpportunityTitle>
                                                        <OpportunityLinkTitle href={opportunity.link}>
                                                            {opportunity.title}
